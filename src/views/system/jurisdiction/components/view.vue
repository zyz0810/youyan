    ...
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-width="120px" >
      ...
      <el-form-item label="市" prop="city">
        <el-select v-model="temp.city" placeholder="选择市" @change="updateDistrict">
          <el-option v-for="option in cityArr" :label="option.name" :value="option.name"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="区" prop="area">
        <el-select v-model="temp.area" placeholder="选择区">
          <el-option v-for="option in districtArr" :label="option.name" :value="option.name"></el-option>
        </el-select>
      </el-form-item>
