  ...
  >
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-width="120px" >
      ...
      <el-form-item label="省" prop="province">
        <el-select v-model="temp.province" placeholder="选择省" @change="updateCity">
          <el-option v-for="(option,index) in arr" :label="option.name" :value="option.name" :key="index"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="市" prop="city">
        <el-select v-model="temp.city" placeholder="选择市" @change="updateDistrict">
          <el-option v-for="(option,index) in cityArr" :label="option.name" :value="option.name" :key="index"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="区" prop="area">
        <el-select v-model="temp.area" placeholder="选择区">
          <el-option v-for="(option,index) in districtArr" :label="option.name" :value="option.name" :key="index"></el-option>
        </el-select>
      </el-form-item>
