<template>
  <div class="app-container">
    <el-row :gutter="10">
      <el-col :xs="24"
        ...
        <div class="chart-wrapper">
          <div class="header-wrapper flex bold"
            ...
            <el-form :inline="true"
              ...
              <el-form-item label="时 间："
                            prop="name">
                <el-date-picker v-model="dateTimeOne"
                                clearable
                                type="daterange"
              ...
              <el-form-item>
                <el-button v-waves
                           ...
                           type="primary"
                           icon="el-icon-search"
                           @click="getPie">查询</el-button>
              </el-form-item>
            </el-form>
          </div>
          <RingChart :chartData="chartDataThree"
                     :PieChartLegend="PieChartLegend"
                     height="200px"></RingChart>
        </div>
        ...
        <div class="chart-wrapper clr_white">
          <div class="header-wrapper flex bold"
            ...
            <el-form :inline="true"
              ...
              <el-form-item label="时 间："
                            prop="name">
                <el-date-picker v-model="dateTimeTwo"
                                clearable
                                type="daterange"
                                value-format="yyyy-MM-dd"
                                range-separator="至"
    ...
    <el-row class="mt_10">
      <el-col :span="24"
              class="p20 chart-wrapper">
        <div class="flex bold"
             style="justify-content:space-between">
          <div class="label f16 txtColor">餐企油烟浓度趋势分析</div>
          <el-form :inline="true"
                   :model="listQueryThree"
                   class="">
            <el-form-item label="餐企名称："
                          prop="name">
              <el-select v-model="listQueryThree.company_id"
                         placeholder="选择餐企">
                <el-option v-for="item in cateringList"
                           :label="item.company"
                           :value="item.id"
            ...
            <el-form-item label="时 间："
                          prop="name">
              <el-date-picker v-model="dateTimeThree"
                              clearable
                              type="daterange"
                              value-format="yyyy-MM-dd"
                              range-separator="至"
            ...
            <el-form-item>
              <el-button v-waves
                         ...
                         type="primary"
                         icon="el-icon-search"
                         @click="getLine">查询</el-button>
            </el-form-item>
          </el-form>
        </div>
        <LineChart :divWidth="divWidth"
